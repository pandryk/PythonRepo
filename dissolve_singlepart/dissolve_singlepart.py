...
class DissolveSinglepart:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'DissolveSinglepart_{}.qm'.format(locale))
        ...
        self.actions = []
        self.menu = self.tr(u'&Dissolve Singlepart')
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/dissolve_singlepart/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'Dissolve Singlepart'),
            callback=self.run,
